...
def global_coord():
    ...
    transform = tf_buffer.lookup_transform("odom","base_laser", rospy.Time(),rospy.Duration(5.0))
...
if __name__=="__main__":
    ...
    sub = rospy.Subscriber('/scan', LaserScan, clbk_laser,queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        x = input("PRESS ENTER FOR FAST RUN!:  \n"+"Press Ctrl-C to Exit")
        if not x:
